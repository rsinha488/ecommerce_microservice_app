...
# Order Service Development Startup Script
...
echo -e "${YELLOW}Starting Order Service (Development Mode)...${NC}"
...
echo -e "${GREEN}Starting Order Service on http://localhost:5003${NC}"
echo ""
