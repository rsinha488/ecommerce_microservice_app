...
# Inventory Service Development Startup Script
...
echo -e "${YELLOW}Starting Inventory Service (Development Mode)...${NC}"
...
echo -e "${GREEN}Starting Inventory Service on http://localhost:3003${NC}"
echo ""
